...
export NEXT_PUBLIC_STACK_API_URL=${NEXT_PUBLIC_STACK_API_URL:-"http://localhost:${BACKEND_PORT}"}
export NEXT_PUBLIC_STACK_DASHBOARD_URL=${NEXT_PUBLIC_STACK_DASHBOARD_URL:-"http://localhost:${DASHBOARD_PORT}"}
...
# Dashboard sentinel for runtime config
export STACK_ENV_VAR_SENTINEL_USE_INLINE_ENV_VARS=${USE_INLINE_ENV_VARS:-false}
export USE_INLINE_ENV_VARS=${STACK_ENV_VAR_SENTINEL_USE_INLINE_ENV_VARS}
