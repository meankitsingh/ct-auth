...
\`\`\`typescript
const response = await fetch('https://authApi.cognitiontree.com/api/v1/users/me', {
  headers: {
    'X-Stack-Access-Type': 'client',
...
\`\`\`typescript
const response = await fetch('https://authApi.cognitiontree.com/api/v1/users/USER_ID', {
  headers: {
    'X-Stack-Access-Type': 'server',
    'X-Stack-Project-Id': 'YOUR_PROJECT_ID',
