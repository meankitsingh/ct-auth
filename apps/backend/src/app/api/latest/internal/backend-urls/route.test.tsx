...
describe('parseAndValidateConfig', () => {
  it('should parse a single entry with probability 1', () => {
    const result = parseAndValidateConfig({
      "1": ["https://authApi.cognitiontree.com"],
    });
    expect(result).toEqual([
      { probability: 1, urls: ["https://authApi.cognitiontree.com"] },
    ]);
  });
  ...
  it('should reject non-array values', () => {
    expect(() => parseAndValidateConfig({ "1": "https://authApi.cognitiontree.com" })).toThrow();
  });
});
