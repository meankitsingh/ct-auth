...
const PROVIDER_GUIDES: ReadonlyMap<string, ProviderGuide> = new Map([
  [
    "google",
    {
      ...
      callbackUrl:
        "https://authApi.cognitiontree.com/api/v1/auth/oauth/callback/google",
    },
  ],
  [
    "github",
    {
      ...
      callbackUrl:
        "https://authApi.cognitiontree.com/api/v1/auth/oauth/callback/github",
    },
  ],
  [
    "facebook",
    {
      ...
      callbackUrl:
        "https://authApi.cognitiontree.com/api/v1/auth/oauth/callback/facebook",
    },
  ],
  [
    "microsoft",
    {
      ...
      callbackUrl:
        "https://authApi.cognitiontree.com/api/v1/auth/oauth/callback/microsoft",
    },
  ],
  [
    "spotify",
    {
      ...
      callbackUrl:
        "https://authApi.cognitiontree.com/api/v1/auth/oauth/callback/spotify",
    },
  ],
  [
    "gitlab",
    {
      ...
      callbackUrl:
        "https://authApi.cognitiontree.com/api/v1/auth/oauth/callback/gitlab",
    },
  ],
  [
    "bitbucket",
    {
      ...
      callbackUrl:
        "https://authApi.cognitiontree.com/api/v1/auth/oauth/callback/bitbucket",
    },
  ],
  [
    "linkedin",
    {
      ...
      callbackUrl:
        "https://authApi.cognitiontree.com/api/v1/auth/oauth/callback/linkedin",
    },
  ],
  [
    "x",
    {
      ...
      callbackUrl:
        "https://authApi.cognitiontree.com/api/v1/auth/oauth/callback/x",
    },
  ],
]);
