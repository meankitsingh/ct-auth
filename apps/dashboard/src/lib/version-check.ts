...
export function checkVersion(
  ...
  if (typeof window !== "undefined" && window.location.origin === "https://accounts.cognitiontree.com") {
  ...
  runAsynchronously(async () => {
    try {
      ...
      const res = await fetch(`https://authApi.cognitiontree.com/api/v1/check-version`, {
        method: "POST",
