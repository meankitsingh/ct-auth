...
function getEnvFileContent(props: {
  ...
  const envFileContent = Object.entries({
    NEXT_PUBLIC_STACK_API_URL: getPublicEnvVar('NEXT_PUBLIC_STACK_API_URL') === "https://authApi.cognitiontree.com" ? undefined : getPublicEnvVar('NEXT_PUBLIC_STACK_API_URL'),
