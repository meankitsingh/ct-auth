...
export function getDefaultProjectId() {
  return envVars.NEXT_PUBLIC_STACK_PROJECT_ID || envVars.STACK_PROJECT_ID || throwErr(new Error("Welcome to Stack Auth! It seems that you haven't provided a project ID. Please create a project on the Stack dashboard at https://accounts.cognitiontree.com and put it in the NEXT_PUBLIC_STACK_PROJECT_ID environment variable."));
}
